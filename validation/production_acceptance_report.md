...
| Storage Availability | PASSED | Available Disk Space: 94998.5 MB |
...
- **Total Tests Discovered:** 1472
- **Passed Count:** 1472
- **Failed Count:** 0
- **Skipped:** 0
- **Duration:** 170.09 seconds
...
| Platform Processing Latency | PASSED | Internal execution startup latency: 0.103 ms |
