...
| Storage Availability | PASSED | Available Disk Space: 94942.9 MB |
...
- **Total Tests Discovered:** 1492
- **Passed Count:** 1492
- **Failed Count:** 0
- **Skipped:** 0
- **Duration:** 215.17 seconds
...
| Platform Processing Latency | PASSED | Internal execution startup latency: 0.079 ms |
