...
| Storage Availability | PASSED | Available Disk Space: 94999.5 MB |
...
- **Total Tests Discovered:** 1437
- **Passed Count:** 1437
- **Failed Count:** 0
- **Skipped:** 0
- **Duration:** 95.15 seconds
...
| Platform Processing Latency | PASSED | Internal execution startup latency: 0.066 ms |
