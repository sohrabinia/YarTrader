...
| Storage Availability | PASSED | Available Disk Space: 94906.3 MB |
...
- **Total Tests Discovered:** 1315
- **Passed Count:** 1315
- **Failed Count:** 0
- **Skipped:** 0
- **Duration:** 175.32 seconds
...
| Platform Processing Latency | PASSED | Internal execution startup latency: 0.09 ms |
