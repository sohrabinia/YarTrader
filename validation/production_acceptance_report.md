...
| Storage Availability | PASSED | Available Disk Space: 94853.0 MB |
...
- **Total Tests Discovered:** 1532
- **Passed Count:** 1532
- **Failed Count:** 0
- **Skipped:** 0
- **Duration:** 208.35 seconds
...
| Platform Processing Latency | PASSED | Internal execution startup latency: 0.071 ms |
