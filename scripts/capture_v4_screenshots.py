...
async def capture_all():
    out_dir = "validation/frontend_v4_implementation"
    ...
    async with async_playwright() as p:
        ...
        await page.evaluate("""() => {
            localStorage.setItem('yartrader_token', 'v4_implementation_verified_token');
        ...
        print("Captured: 17_fa_rtl_desktop.png")
        ...
        print("Captured: 18_ar_rtl_desktop.png")
        ...
        print("Captured: 19_mobile_375px_dashboard.png")
