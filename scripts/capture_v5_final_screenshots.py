...
async def capture_v5_final():
    out_dir = "validation/frontend_v5_final"
    ...
    async with async_playwright() as p:
        ...
        await page.evaluate("""() => {
            localStorage.setItem('yartrader_token', 'v5_final_verified_token');
            localStorage.setItem('yartrader_role', 'ADMIN');
            localStorage.setItem('yartrader_name', 'SRE Principal Lead');
        ...
        for hash_route, filename in routes:
            ...
            print(f"Captured V5 Final: {target_path}")
        ...
        print("Captured V5 Final: 17_fa_rtl_desktop.png")
        ...
        print("Captured V5 Final: 18_ar_rtl_desktop.png")
        ...
        await mobile_page.evaluate("""() => {
            localStorage.setItem('yartrader_token', 'v5_final_verified_token');
            localStorage.setItem('yartrader_role', 'ADMIN');
            localStorage.setItem('yartrader_name', 'SRE Mobile Lead');
            localStorage.setItem('yartrader_language', 'fa');
        }""")
        ...
        print("Captured V5 Final: 19_mobile_375px_dashboard.png")

        await browser.close()

if __name__ == "__main__":
    asyncio.run(capture_v5_final())
