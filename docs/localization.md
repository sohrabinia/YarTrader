...
- **Persian**: `۱۴۰۵/۰۵/۰7 ۱۰:۳۰` (using native Persian digits and dynamic RTL alignment).
- **English**: `2026-07-29 10:30` (using standard ISO structures).
...
1. Add your localizable UI elements with a `data-i18n` attribute pointing to a unique translation key:
   ...
   ```
2. Update both locale JSON files under `static/locales/`:
