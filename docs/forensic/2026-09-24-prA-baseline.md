...
**Audit Date**: 2026-09-24 02:40:00 UTC
**REPORT_GENERATED_AT_UTC**: 2026-09-24 02:40:00 UTC
...
**MERGE_BASE**: `e6af8503767618e2279810862ce7a435d6a74753`
**PR_HEAD_SHA**: `5303f7626997b7cb3b27b407421c43555ae3b259`
...
Saved research snapshot to: /tmp/YarTraderAI/Runtime/research_logs/research_snapshots/rpt-XAUUSD-H1-snapshot_1790249837.json
...
================ 2 passed, 1922 deselected, 1 warning in 3.98s =================
```
...
```text
================ 1924 passed, 1253 warnings in 292.07s (0:04:52) ================
```
