...
class TestMarketSessionEngine:
    ...
    def setup_method(self):
        ...
        self.engine.kill_switch.set_session_baseline(10000.0, "2026-03-23")
    ...
    def test_crypto_saturday_multiple_intervals(self):
        ...
        res_09 = self.engine.validate_pre_entry(symbol="BTCUSD", current_time=t_09, current_equity=10000.0, session_baseline_equity=10000.0)
        ...
        res_1230 = self.engine.validate_pre_entry(symbol="BTCUSD", current_time=t_1230, current_equity=10000.0, session_baseline_equity=10000.0)
        ...
        res_14 = self.engine.validate_pre_entry(symbol="BTCUSD", current_time=t_14, current_equity=10000.0, session_baseline_equity=10000.0)
