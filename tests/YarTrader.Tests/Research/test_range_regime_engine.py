...
def test_case_1_pullback_classification():
    ...
    res = engine.evaluate_regime(candles=candles, hurst_val=0.40, htf_bias="BULLISH", range_val=1.0)
...
def test_case_2_range_classification():
    ...
    res = engine.evaluate_regime(candles=candles, hurst_val=0.42, fractal_dim=1.45, htf_bias="NEUTRAL", range_val=2.0)
...
def test_case_3_range_lower_boundary_rejection_long():
    ...
    res = engine.evaluate_regime(candles=candles, hurst_val=0.40, fractal_dim=1.50, htf_bias="NEUTRAL", range_val=2.0)
    assert res.regime == "RANGE"
...
def test_case_5_breakout_transition():
    ...
    res = engine.evaluate_regime(candles=candles, hurst_val=0.75, fractal_dim=1.20, htf_bias="NEUTRAL", range_val=0.5)
