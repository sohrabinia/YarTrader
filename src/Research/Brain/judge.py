...
from src.Research.Brain.models import VirtualTrade, Hypothesis, PatternMemory, SimulatedDecision
...
class JudgeBrain:
    ...
    """
    def __init__(self, min_supporting_samples: int = 3, min_confidence_threshold: float = 0.60) -> None:
