...
class ProductionConfig:
    ...
    def _validate_and_initialize(self) -> None:
        ...
        # YarTrader Storage Isolation Configuration (Task 39)
        default_root = "C:\\YarTraderAI\\" if os.name == "nt" else "/tmp/YarTraderAI/"
        self.storage_root = os.getenv("YarTraderStorageRoot", os.getenv("YarTraderStorageRoot", self._settings.get("YarTraderStorageRoot", default_root)))
