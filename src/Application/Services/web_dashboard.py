...
def check_admin_guard(request_or_token: Any = None, session_token: Optional[str] = None):
    ...
    if session and not role and isinstance(session.get("user"), dict):
        role = session["user"].get("role")
    if not session or role != "ADMIN":
...
def get_admin_symbols(request: Request, token: Optional[str] = None):
    ...
    check_admin_guard(request, token)
    from src.ShadowTrading.Engine.SymbolRegistry import SymbolRegistry
...
def get_admin_timeframes(request: Request, token: Optional[str] = None):
...
def get_admin_reports(request: Request, symbol: Optional[str] = None, timeframe: Optional[int] = None, token: Optional[str] = None):
...
def get_admin_shadow_trades(request: Request, symbol: Optional[str] = None, timeframe: Optional[int] = None, token: Optional[str] = None):
...
def get_admin_memory_view(request: Request, symbol: Optional[str] = None, timeframe: Optional[int] = None, token: Optional[str] = None):
...
def get_admin_judge_panel(request: Request, symbol: Optional[str] = None, timeframe: Optional[int] = None, token: Optional[str] = None):
...
def get_admin_patterns_view(request: Request, symbol: Optional[str] = None, timeframe: Optional[int] = None, token: Optional[str] = None):
...
def get_operator_status(request: Request):
    ...
    Guarded strictly by check_admin_guard authorization (Bearer token).
    """
    admin_session = check_admin_guard(request)
...
def submit_operator_task(request: Request, payload: OperatorTaskSubmitPayload):
    """
...
def get_operator_task_details(request: Request, task_id: str):
    """
